...
extension TableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if even {
            tableViewCell.setup(PullRequestView(title: "PR #\(indexPath.row) - Testes do componente", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras gravida vulputate dictum. Cras rhoncus varius fringilla.", authorName: "Meu Nome Muito Legal", authorAvatarURL: URL(string: "https://avatars.githubusercontent.com/u/116613733?v=4"), state: nil))
        } else {
