...
extension TableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if even {
            tableViewCell.setup(PullRequestView(title: "PR #\(indexPath.row) - Testes do componente", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras gravida vulputate dictum. Cras rhoncus varius fringilla.", name: "Meu Nome Muito Legal", avatarURL: URL(string: "https://avatars.githubusercontent.com/u/116613733?v=4")))
        } else {
